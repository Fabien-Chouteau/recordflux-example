...
is
   ...
   type Structure is
      record
         Kind : RFLX.RSP.Answer_Kind;
         Length : RFLX.RSP.Length;
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Answer_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Answer_Message.Valid_Structure (Struct)
       and then RFLX.RSP.Answer_Message.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (To_Base_Integer (Struct.Kind) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Answer_Data)));
