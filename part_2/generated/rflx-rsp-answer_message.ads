...
is
   ...
   type Virtual_Field is (F_Initial, F_Kind, F_Length, F_Server_Result, F_Payload, F_Final);

   subtype Field is Virtual_Field range F_Kind .. F_Payload;
   ...
   function Get_Length (Ctx : Context) return RFLX.RSP.Length with
     Pre =>
       RFLX.RSP.Answer_Message.Valid (Ctx, RFLX.RSP.Answer_Message.F_Length);
   ...
   function Get_Payload (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.RSP.Answer_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Answer_Message.Well_Formed (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Payload),
     Post =>
   ...
   procedure Get_Payload (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Answer_Message.Well_Formed (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Payload)),
     Post =>
   ...
   procedure Generic_Get_Payload (Ctx : Context) with
     Pre =>
       RFLX.RSP.Answer_Message.Has_Buffer (Ctx)
       and RFLX.RSP.Answer_Message.Present (Ctx, RFLX.RSP.Answer_Message.F_Payload);
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.RSP.Length) with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Answer_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Length)
       and then RFLX.RSP.Valid_Length (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Length) >= RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Length)
       and then RFLX.RSP.Answer_Message.Field_Condition (Ctx, RFLX.RSP.Answer_Message.F_Length, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Payload_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.RSP.Answer_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Payload) >= RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Field_Condition (Ctx, RFLX.RSP.Answer_Message.F_Payload, 0)
       and then RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Payload (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Payload) >= RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Valid_Length (Ctx, RFLX.RSP.Answer_Message.F_Payload, Data'Length)
       and then RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.RSP.Answer_Message.Field_Condition (Ctx, RFLX.RSP.Answer_Message.F_Payload, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   procedure Generic_Set_Payload (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.RSP.Answer_Message.Valid_Next (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Payload) >= RFLX.RSP.Answer_Message.Field_Size (Ctx, RFLX.RSP.Answer_Message.F_Payload)
       and then RFLX.RSP.Answer_Message.Valid_Length (Ctx, RFLX.RSP.Answer_Message.F_Payload, Length)
       and then RFLX_Types.To_Length (RFLX.RSP.Answer_Message.Available_Space (Ctx, RFLX.RSP.Answer_Message.F_Payload)) >= Length
...
private
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean is
     ((case Ctx.Cursors (Fld).Predecessor is
          when F_Initial | F_Length | F_Server_Result | F_Payload | F_Final =>
             True,
          when F_Kind =>
             (case Fld is
                 when F_Length =>
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     ((case Fld is
          ...
          when F_Length | F_Server_Result | F_Payload =>
             True));

   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length is
     ((case Fld is
          when F_Kind | F_Length | F_Server_Result =>
             8,
          when F_Payload =>
