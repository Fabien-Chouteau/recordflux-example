...
is
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.RSP.Length) is
   begin
   ...
   procedure Initialize_Payload_Private (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message.Field_First (Ctx, RFLX.RSP.Request_Message.F_Payload) mod RFLX_Types.Byte'Size = 1,
     Post =>
       Has_Buffer (Ctx)
