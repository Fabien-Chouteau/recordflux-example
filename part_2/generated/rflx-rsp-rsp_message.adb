...
is
   ...
   function Composite_Field (Fld : Field) return Boolean is
     (Fld in F_Answer_Payload | F_Request_Payload);
   ...
   is
      ...
      Size : constant Positive := (case Fld is
          when F_Kind | F_Answer_Kind | F_Request_Stack_Id | F_Answer_Length | F_Answer_Server_Result | F_Request_Kind | F_Request_Length =>
             8,
          when others =>
             Positive'Last);
   ...
   procedure Set_Scalar (Ctx : in out Context; Fld : Field; Val : RFLX_Types.Base_Integer) with
     Pre =>
       ...
       and then RFLX.RSP.RSP_Message.Valid_Next (Ctx, Fld)
       and then Fld in F_Kind | F_Answer_Kind | F_Request_Stack_Id | F_Answer_Length | F_Answer_Server_Result | F_Request_Kind | F_Request_Length
       and then RFLX.RSP.RSP_Message.Valid_Value (Fld, Val)
