...
package RFLX.RSP.Request_Message with
  SPARK_Mode,
  Annotate =>
...
is
   ...
   type Virtual_Field is (F_Initial, F_Kind, F_Length, F_Payload, F_Stack_Id, F_Final);

   subtype Field is Virtual_Field range F_Kind .. F_Stack_Id;
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.RSP.Request_Message.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Take_Buffer (Ctx : in out Context; Buffer : out RFLX_Types.Bytes_Ptr) with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and Buffer /= null
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Well_Formed_Message (Ctx)
       and then RFLX.RSP.Request_Message.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then Offset < RFLX.RSP.Request_Message.Buffer_Length (Ctx)
       and then Pre (RFLX.RSP.Request_Message.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.RSP.Request_Message.Byte_Size (Ctx);
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message.Valid_Predecessor (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Predecessor (Ctx, Fld)
       and then RFLX.RSP.Request_Message.Valid_Value (Fld, Val)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, Fld)
       and then RFLX.RSP.Request_Message.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.RSP.Request_Message.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Payload =>
   ...
   function Equal (Ctx : Context; Fld : Field; Data : RFLX_Types.Bytes) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and RFLX.RSP.Request_Message.Valid_Next (Ctx, Fld);
   ...
   function Get_Kind (Ctx : Context) return RFLX.RSP.Request_Kind with
     Pre =>
       RFLX.RSP.Request_Message.Valid (Ctx, RFLX.RSP.Request_Message.F_Kind);

   function Get_Length (Ctx : Context) return RFLX.RSP.Length with
     Pre =>
       RFLX.RSP.Request_Message.Valid (Ctx, RFLX.RSP.Request_Message.F_Length);

   function Get_Stack_Id (Ctx : Context) return RFLX.RSP.Stack_Identifier with
     Pre =>
       RFLX.RSP.Request_Message.Valid (Ctx, RFLX.RSP.Request_Message.F_Stack_Id);
   ...
   function Get_Payload (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Well_Formed (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Payload),
     Post =>
   ...
   procedure Get_Payload (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message.Well_Formed (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Payload)),
     Post =>
   ...
   procedure Generic_Get_Payload (Ctx : Context) with
     Pre =>
       RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and RFLX.RSP.Request_Message.Present (Ctx, RFLX.RSP.Request_Message.F_Payload);
   ...
   procedure Set_Kind (Ctx : in out Context; Val : RFLX.RSP.Request_Kind) with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Kind)
       and then RFLX.RSP.Valid_Request_Kind (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Kind) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Kind)
       and then RFLX.RSP.Request_Message.Field_Condition (Ctx, RFLX.RSP.Request_Message.F_Kind, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Kind (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Select_Stack))
            then
               Predecessor (Ctx, F_Stack_Id) = F_Kind
               and Valid_Next (Ctx, F_Stack_Id))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.RSP.Length) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Length)
       and then RFLX.RSP.Valid_Length (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Length) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Length)
       and then RFLX.RSP.Request_Message.Field_Condition (Ctx, RFLX.RSP.Request_Message.F_Length, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Stack_Id (Ctx : in out Context; Val : RFLX.RSP.Stack_Identifier) with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Stack_Id)
       and then RFLX.RSP.Valid_Stack_Identifier (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Stack_Id) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Stack_Id)
       and then RFLX.RSP.Request_Message.Field_Condition (Ctx, RFLX.RSP.Request_Message.F_Stack_Id, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Stack_Id)
       and Get_Stack_Id (Ctx) = Val
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Stack_Id))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       ...
       and Field_Last (Ctx, F_Stack_Id) = Field_Last (Ctx, Predecessor (Ctx, F_Stack_Id)) + Field_Size (Ctx, F_Stack_Id)
       and (for all F in Field range F_Kind .. F_Payload =>
               Context_Cursors_Index (Context_Cursors (Ctx), F) = Context_Cursors_Index (Context_Cursors (Ctx)'Old, F));
   ...
   procedure Set_Payload_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Payload) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Field_Condition (Ctx, RFLX.RSP.Request_Message.F_Payload, 0)
       and then RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
       and Invalid (Ctx, F_Stack_Id)
       and (Predecessor (Ctx, F_Stack_Id) = F_Payload
            and Valid_Next (Ctx, F_Stack_Id))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
   ...
   procedure Set_Payload (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Payload) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Valid_Length (Ctx, RFLX.RSP.Request_Message.F_Payload, Data'Length)
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.RSP.Request_Message.Field_Condition (Ctx, RFLX.RSP.Request_Message.F_Payload, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   procedure Generic_Set_Payload (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message.Valid_Next (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Payload) >= RFLX.RSP.Request_Message.Field_Size (Ctx, RFLX.RSP.Request_Message.F_Payload)
       and then RFLX.RSP.Request_Message.Valid_Length (Ctx, RFLX.RSP.Request_Message.F_Payload, Length)
       and then RFLX_Types.To_Length (RFLX.RSP.Request_Message.Available_Space (Ctx, RFLX.RSP.Request_Message.F_Payload)) >= Length
...
private
     ...
     ((if Buffer /= null then Buffer'First = Buffer_First and Buffer'Last = Buffer_Last)
      ...
      and then ((if
                ...
                and then (if
                          ...
                          then
                             (Valid (Cursors (F_Kind))
                              and then Cursors (F_Stack_Id).Predecessor = F_Kind
                              and then RFLX_Types.Base_Integer (Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Select_Stack)))
                             or (Well_Formed (Cursors (F_Payload))
                                 and then Cursors (F_Stack_Id).Predecessor = F_Payload)))
      and then ((if Invalid (Cursors (F_Kind)) then Invalid (Cursors (F_Length)))
                ...
                and then (if
                             ...
                             and then Invalid (Cursors (F_Payload))
                          then
                             Invalid (Cursors (F_Stack_Id))))
      and then (if
                                          ...
                                          then
                                             ...
                                             and then (if
                                                       ...
                                                       then
                                                          ...
                                                          and then Cursors (F_Stack_Id).Predecessor = F_Payload
                                                          and then Cursors (F_Stack_Id).First = Cursors (F_Payload).Last + 1)))
                   and then (if
                                Well_Formed (Cursors (F_Stack_Id))
                                and then RFLX_Types.Base_Integer (Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Select_Stack))
                             then
                                Cursors (F_Stack_Id).Last - Cursors (F_Stack_Id).First + 1 = 8
                                and then Cursors (F_Stack_Id).Predecessor = F_Kind
                                and then Cursors (F_Stack_Id).First = Cursors (F_Kind).Last + 1)))
    with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.RSP.Request_Message.Field_First (Ctx, RFLX.RSP.Request_Message.F_Kind) rem RFLX_Types.Byte'Size = 1
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean is
     ((case Ctx.Cursors (Fld).Predecessor is
          when F_Initial | F_Length | F_Payload | F_Stack_Id | F_Final =>
             True,
          when F_Kind =>
             (case Fld is
                 when F_Length =>
                 ...
                 when F_Stack_Id =>
                    RFLX_Types.Base_Integer (Ctx.Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Select_Stack)),
                 when others =>
                    False)));
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     ((case Fld is
          ...
          when F_Length | F_Payload | F_Stack_Id =>
             True));
   ...
   function Get_Length (Ctx : Context) return RFLX.RSP.Length is
