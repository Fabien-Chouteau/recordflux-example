--
-- Generated by RecordFlux 0.9.1.dev18+ge578157d on 2023-03-15
--
...
package RFLX.RSP.Request_Message_With_Id with
  SPARK_Mode,
  Annotate =>
...
is
   ...
   type Virtual_Field is (F_Initial, F_Stack_Id, F_Kind, F_Length, F_Payload, F_Final);

   subtype Field is Virtual_Field range F_Stack_Id .. F_Payload;
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Take_Buffer (Ctx : in out Context; Buffer : out RFLX_Types.Bytes_Ptr) with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and Buffer /= null
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Well_Formed_Message (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then Offset < RFLX.RSP.Request_Message_With_Id.Buffer_Length (Ctx)
       and then Pre (RFLX.RSP.Request_Message_With_Id.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.RSP.Request_Message_With_Id.Byte_Size (Ctx);
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Valid_Predecessor (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Predecessor (Ctx, Fld)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Value (Fld, Val)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, Fld)
       and then RFLX.RSP.Request_Message_With_Id.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Payload =>
   ...
   function Equal (Ctx : Context; Fld : Field; Data : RFLX_Types.Bytes) return Boolean with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, Fld);
   ...
   function Get_Stack_Id (Ctx : Context) return RFLX.RSP.Stack_Identifier with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Valid (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id);

   function Get_Kind (Ctx : Context) return RFLX.RSP.Request_Kind with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Valid (Ctx, RFLX.RSP.Request_Message_With_Id.F_Kind);

   function Get_Length (Ctx : Context) return RFLX.RSP.Payload_Length with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Valid (Ctx, RFLX.RSP.Request_Message_With_Id.F_Length);
   ...
   function Get_Payload (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Well_Formed (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload),
     Post =>
   ...
   procedure Get_Payload (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message_With_Id.Well_Formed (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)),
     Post =>
   ...
   procedure Generic_Get_Payload (Ctx : Context) with
     Pre =>
       RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and RFLX.RSP.Request_Message_With_Id.Present (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload);
   ...
   procedure Set_Stack_Id (Ctx : in out Context; Val : RFLX.RSP.Stack_Identifier) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id)
       and then RFLX.RSP.Valid_Stack_Identifier (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id)
       and then RFLX.RSP.Request_Message_With_Id.Field_Condition (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Stack_Id)
       and Get_Stack_Id (Ctx) = Val
       and Invalid (Ctx, F_Kind)
       and Invalid (Ctx, F_Length)
       and Invalid (Ctx, F_Payload)
       and (Predecessor (Ctx, F_Kind) = F_Stack_Id
            and Valid_Next (Ctx, F_Kind))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       and Predecessor (Ctx, F_Stack_Id) = Predecessor (Ctx, F_Stack_Id)'Old
       and Valid_Next (Ctx, F_Stack_Id) = Valid_Next (Ctx, F_Stack_Id)'Old
       and Field_First (Ctx, F_Stack_Id) = Field_First (Ctx, F_Stack_Id)'Old;

   procedure Set_Kind (Ctx : in out Context; Val : RFLX.RSP.Request_Kind) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Kind)
       and then RFLX.RSP.Valid_Request_Kind (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Kind) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Kind)
       and then RFLX.RSP.Request_Message_With_Id.Field_Condition (Ctx, RFLX.RSP.Request_Message_With_Id.F_Kind, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and Invalid (Ctx, F_Payload)
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Kind (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Store))
            then
               Predecessor (Ctx, F_Length) = F_Kind
       ...
       and Get_Stack_Id (Ctx) = Get_Stack_Id (Ctx)'Old
       and Field_First (Ctx, F_Kind) = Field_First (Ctx, F_Kind)'Old
       and Field_Last (Ctx, F_Kind) = Field_Last (Ctx, Predecessor (Ctx, F_Kind)) + Field_Size (Ctx, F_Kind)
       and (for all F in Field range F_Stack_Id .. F_Stack_Id =>
               Context_Cursors_Index (Context_Cursors (Ctx), F) = Context_Cursors_Index (Context_Cursors (Ctx)'Old, F));

   procedure Set_Length (Ctx : in out Context; Val : RFLX.RSP.Payload_Length) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Length)
       and then RFLX.RSP.Valid_Payload_Length (RFLX.RSP.To_Base_Integer (Val))
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Length) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Length)
       and then RFLX.RSP.Request_Message_With_Id.Field_Condition (Ctx, RFLX.RSP.Request_Message_With_Id.F_Length, RFLX.RSP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (for all F in Field range F_Stack_Id .. F_Kind =>
               Context_Cursors_Index (Context_Cursors (Ctx), F) = Context_Cursors_Index (Context_Cursors (Ctx)'Old, F));
   ...
   procedure Set_Payload_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Field_Condition (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload, 0)
       and then RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Payload (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Length (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload, Data'Length)
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.RSP.Request_Message_With_Id.Field_Condition (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   procedure Generic_Set_Payload (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.RSP.Request_Message_With_Id.Valid_Next (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload) >= RFLX.RSP.Request_Message_With_Id.Field_Size (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Length (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload, Length)
       and then RFLX_Types.To_Length (RFLX.RSP.Request_Message_With_Id.Available_Space (Ctx, RFLX.RSP.Request_Message_With_Id.F_Payload)) >= Length
   ...
   type Structure is
      record
         ...
         Kind : RFLX.RSP.Request_Kind;
         Length : RFLX.RSP.Payload_Length;
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message_With_Id.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message_With_Id.Valid_Structure (Struct)
       and then RFLX.RSP.Request_Message_With_Id.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Stack_Id (Struct : Structure) return RFLX_Types.Bit_Length with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_Kind (Struct : Structure) return RFLX_Types.Bit_Length with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Valid_Context (Buffer_First, Buffer_Last : RFLX_Types.Index; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Buffer : RFLX_Types.Bytes_Ptr; Cursors : Field_Cursors) return Boolean is
     ((if Buffer /= null then Buffer'First = Buffer_First and Buffer'Last = Buffer_Last)
      ...
      and then ((if
                 ...
                 then
                    (Valid (Cursors (F_Stack_Id))
                     and then Cursors (F_Kind).Predecessor = F_Stack_Id))
                and then (if
                             Well_Formed (Cursors (F_Length))
                          then
                             (Valid (Cursors (F_Kind))
                              and then Cursors (F_Length).Predecessor = F_Kind
                              and then RFLX_Types.Base_Integer (Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Store))))
                and then (if
                             Well_Formed (Cursors (F_Payload))
                          then
                             (Valid (Cursors (F_Length))
                              and then Cursors (F_Payload).Predecessor = F_Length)))
      and then ((if Invalid (Cursors (F_Stack_Id)) then Invalid (Cursors (F_Kind)))
                and then (if Invalid (Cursors (F_Kind)) then Invalid (Cursors (F_Length)))
                and then (if Invalid (Cursors (F_Length)) then Invalid (Cursors (F_Payload))))
      and then (if
                   Well_Formed (Cursors (F_Stack_Id))
                then
                   Cursors (F_Stack_Id).Last - Cursors (F_Stack_Id).First + 1 = 8
                   and then Cursors (F_Stack_Id).Predecessor = F_Initial
                   and then Cursors (F_Stack_Id).First = First
                   and then (if
                                Well_Formed (Cursors (F_Kind))
                             then
                                Cursors (F_Kind).Last - Cursors (F_Kind).First + 1 = 8
                                and then Cursors (F_Kind).Predecessor = F_Stack_Id
                                and then Cursors (F_Kind).First = Cursors (F_Stack_Id).Last + 1
                                and then (if
                                             Well_Formed (Cursors (F_Length))
                                             and then RFLX_Types.Base_Integer (Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Store))
                                          then
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      and then Valid_Next (Ctx, F_Stack_Id)
      and then RFLX.RSP.Request_Message_With_Id.Field_First (Ctx, RFLX.RSP.Request_Message_With_Id.F_Stack_Id) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Stack_Id) = Ctx.Last - Ctx.First + 1
      and then (for all F in Field =>
                   Invalid (Ctx, F)));
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     ((case Fld is
          ...
          when F_Length =>
             RFLX.RSP.Valid_Payload_Length (Val),
          when F_Payload =>
             True));

   function Path_Condition (Ctx : Context; Fld : Field) return Boolean is
     ((case Ctx.Cursors (Fld).Predecessor is
          when F_Initial | F_Stack_Id | F_Length | F_Payload | F_Final =>
             True,
          when F_Kind =>
             RFLX_Types.Base_Integer (Ctx.Cursors (F_Kind).Value) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Store))));
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length is
     ((case Fld is
          when F_Stack_Id | F_Kind | F_Length =>
             8,
          when F_Payload =>
             RFLX_Types.Bit_Length (Ctx.Cursors (F_Length).Value) * 8));

   function Field_First (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Index is
     ((if Fld = F_Stack_Id then Ctx.First else Ctx.Cursors (Ctx.Cursors (Fld).Predecessor).Last + 1));
   ...
   function Valid_Predecessor (Ctx : Context; Fld : Virtual_Field) return Boolean is
     ((case Fld is
          ...
          when F_Kind =>
             (Valid (Ctx.Cursors (F_Stack_Id))
              and Ctx.Cursors (Fld).Predecessor = F_Stack_Id),
          when F_Length =>
   ...
   function Get_Stack_Id (Ctx : Context) return RFLX.RSP.Stack_Identifier is
     (To_Actual (Ctx.Cursors (F_Stack_Id).Value));

   function Get_Kind (Ctx : Context) return RFLX.RSP.Request_Kind is
     (To_Actual (Ctx.Cursors (F_Kind).Value));

   function Get_Length (Ctx : Context) return RFLX.RSP.Payload_Length is
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (To_Base_Integer (Struct.Kind) = RFLX_Types.Base_Integer (To_Base_Integer (RFLX.RSP.Request_Store)));
   ...
   function Field_Size_Stack_Id (Struct : Structure) return RFLX_Types.Bit_Length is
     (8);
...
end RFLX.RSP.Request_Message_With_Id;
