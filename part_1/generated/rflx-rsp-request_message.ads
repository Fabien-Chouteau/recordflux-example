...
is
   ...
   type Virtual_Field is (F_Initial, F_Kind, F_Length, F_Payload, F_Final);
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.RSP.Request_Message.Has_Buffer (Ctx)
       and then RFLX.RSP.Request_Message.Valid_Structure (Struct)
       and then RFLX.RSP.Request_Message.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
